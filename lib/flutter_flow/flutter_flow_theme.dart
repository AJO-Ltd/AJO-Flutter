...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF9B30D9);
  late Color secondary = const Color(0xFFFB8B24);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFF5F5F5);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF5F5F5);
  late Color secondaryBackground = const Color(0xFFFFFAFA);
  late Color accent1 = const Color(0x67395CEF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFFEAEAEA);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF9D3FD5);
  late Color secondary = const Color(0xFFFB8B24);
  late Color tertiary = const Color(0xFFEE8B60);
  ...
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFF3B3B3B);
  late Color accent4 = const Color(0xFF4C4D4E);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);
